        ...
        {videos.map((video, index) => (
          ...
          >
            ...
            <div className="px-6 py-5">
              ...
              <button className="w-full flex items-center justify-center gap-2 bg-gray-900 text-white py-2 px-4 text-xs tracking-widest uppercase hover:bg-gray-800 transition-colors duration-200">
